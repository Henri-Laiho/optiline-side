...
from OpenCV.Backup.Src.CameraModuls import *
from OpenCV.Backup.Src.MorseCode import *
from OpenCV.Backup.Src import MorseDecoderAdaptive
...
if __name__ == '__main__':
    ...
    decoder = MorseDecoderAdaptive(
        min_pulse_length=adaptive_decoder_min_pulse_length) if use_adaptive_decoder else MorseDecoder(args.mlong,
                                                                                                      args.mshort,
                                                                                                      args.mblank)
